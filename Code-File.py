...
Chanal :  https://t.me/CodeManCrackers
...
def menu():
	...
	_KakTarani_(f'\x1b[1;98m[ 1 ] CRACK BA FILE IDS[WORK]')
	

	_____KakTarani_____ = input('\x1b[1;96mSELECT :\x1b[1;97m ')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r •KakTarani• {P}{b}{loop}{P}•{b}{len(id)}{P}  • OK:{P}{H}{ok}{P} •  CP:{P}{M}{cp}{P} • ({bo}{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
